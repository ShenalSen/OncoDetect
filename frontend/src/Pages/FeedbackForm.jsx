...
const FeedbackForm = () => {
  ...
  return (
    <div
      className="max-w-md mx-auto bg-white shadow-md p-6 rounded-lg mt-6 pb-10 pt-10"
      style={{ padding: "16px", paddingTop: "50px", paddingBottom: "50px" }} // Added paddingTop and paddingBottom
    >
